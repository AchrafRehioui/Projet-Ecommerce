...
const { createProduct, showProduct, productById, removeProduct, updateProduct, allProducts, relatedProduct, SearchProduct } = require('../controllers/productController');
